...
define('JOMRES_TEMP_RELPATH', JOMRES_ROOT_DIRECTORY.'/temp/');
...
require_once JOMRESCONFIG_ABSOLUTE_PATH.JRDS.JOMRES_ROOT_DIRECTORY.JRDS.'libraries'.JRDS.'PHPMailer-5.2.21'.JRDS.'PHPMailerAutoload.php';
